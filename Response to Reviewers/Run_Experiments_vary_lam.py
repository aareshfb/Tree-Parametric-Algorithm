...
def Run_Exp(Q,c,lam,filename,nL,LAM_VAL):
    ...
    # gurobi_true_obj_M=0.5*x_g_np_M.T@Q@x_g_np_M+x_g_np_M.T@c+lam.T@(x_g_np_M!=0)
    ...
    data={'n':n,'Levels':nL,'Depth':Depth,'Number_of_non_zeros':Non_zeros,'lam_val':LAM_VAL,'Gurobi_obj_P':g_sol,
          ...
          'BnB_Nodes_P':BnB_Nodes,'M':M,'Gurobi_obj_M':g_sol_M,
          'Gurobi_opt_gap_M':Gap_g_M,'Objective_Diff_M':(opt_p-g_sol_M),
...
if __name__ == "__main__":
    ...
    FileName='Vary_lam_rand_n200.csv'
    no_exp=1
    size=int(sys.argv[1])
